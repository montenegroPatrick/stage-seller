...
export default function Header() {
  ...
  return (
    <section className="bg-fixed bg-center bg-cover custom-img h-screen flex items-center justify-center">
      <div className="absolute top-0 right-0 left-0 bottom-0 bg-black/70 z-[2]" />
      <div className="p-5 text-whiteSmoke z-[2]">
        <h2 className="text-4xl sm:text-6xl font-jetbrains">Trouvez votre stagiaire</h2>
