...
export default function ProfileCarte({ user }) {
  ...
  return (
    ...
    <div  className="relative">
      <a
        href="#"
        className="relative block overflow-hidden rounded-lg bg-white border border-gray-500 p-4 sm:p-6 lg:p-8 mt-4 mx-2"
      >
        <span className="absolute inset-x-0 bottom-0 h-2 bg-gradient-to-r from-green-300 via-blue-500 to-purple-600"></span>

        <div className="sm:flex sm:justify-between sm:gap-4">
          <div>
            <h3 className="text-lg font-bold text-magenta sm:text-xl ">
              Kechiche Younes
              {/* {role === "students" ? `${lastName}  ${firstName}` : `${companyName}`} */}
            </h3>
